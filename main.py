...
def run_the_net(train_file, class_list, test_file=None):
    ...
    for image_id, data in enumerate(dataset_test):
        ...
        valid_scores_indices = (scores > scores_threshold)[0]
        ...
        for label in range(dataset_test.num_classes()):
            all_annotations[i][label] = annotation[annotation[:, 4] == label, :4].copy()
...
if __name__ == '__main__':
    run_the_net('data/annotations.csv', 'data/classes.csv')
